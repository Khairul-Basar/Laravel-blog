            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ALL Favorite Posts
                            <span class="badge bg-deep-purple">{{ $posts->count() }}</span>
                        </h2>
                    </div>
                    <div class="body">
...
{{--                                    <th class="text-center"><i class="material-icons">comment</i></th>--}}
                                ...
                                <tbody>
                                    @foreach($posts as $key=>$post)
                                        <tr>
                                            <td>{{ $key +1 }}</td>
                                            <td><strong>{{ str_limit($post->title,'20') }}</strong></td>
                                            <td><strong>{{ $post->user->name }}</strong></td>
                                            <td class="text-center"><strong>{{ $post->favorite_to_users->count() }}</strong></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger waves-effect"
                                                        type="button" onclick="removePost({{ $post->id }})">
