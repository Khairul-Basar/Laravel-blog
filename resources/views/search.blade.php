...
@section('content')
    ...
    <div class="slider display-table center-text">
        <h1 class="title display-table-cell"><b style="color: #00E676;">{{ $posts->count() }} Results For {{ $query }}</b></h1>
    </div><!-- slider -->
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card h-100">
                                <div class="single-post post-style-1">
                                    ...
                                    <a class="avatar" href="#"><img src="{{ url('storage/profile/'.$post->user->image) }}" alt="{{ $post->user->name }}"></a>
                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <h4 class="title" style="color: red"><b> Sorry, No Post Found for this Search....!!! </b></h4>
